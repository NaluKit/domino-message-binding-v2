...
public class DominoV2MessageProcessorUtils {
  ...
  private DominoV2MessageProcessorUtils(Builder builder) {
    super();
  ...
  public static class Builder {
    ...
    public DominoV2MessageProcessorUtils build() {
      return new DominoV2MessageProcessorUtils(this);
    }
